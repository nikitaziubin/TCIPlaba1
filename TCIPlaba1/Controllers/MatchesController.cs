    ...
    public class MatchesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Matches != null ? 
                          ...
                          Problem("Entity set 'Ictplaba1Context.Matches'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Date,Division")] Match match)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Date,Division")] Match match)
        {
            if (id != match.Id)
            {
                return NotFound();
